        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="d-flex flex-column flex-lg-row">
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-center flex-column py-5">
                                ...
                                <!--end::Avatar-->
                                <!--begin::Name-->
                                <a href="#" class="fs-3 text-gray-800 mb-1">@php echo ucfirst($userInfo['fname'])@endphp <span
                                        class="text-primary">@php echo mb_strtoupper($userInfo['lname'])@endphp</span></a>
                                <!--end::Name-->
                                <!--begin::Position-->
                                {{-- <div class="mb-9">
                                    <!--begin::Badge-->
                                    <div class="fs-3 text-muted d-block">Admin</div>
                                    <!--begin::Badge-->
                                </div>
                                <!--end::Position-->
                                <!--begin::Info-->
                                <!--begin::Info heading-->
                                <div class="fw-bold mb-3">Tickets assignés
                                    <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="popover"
                                        data-bs-trigger="hover" data-bs-html="true"
                                        data-bs-content="Nombre de tickets d'assistance attribués, fermés et en attente cette semaine."></i>
                                </div>
                                <!--end::Info heading-->
                                <div class="d-flex flex-wrap flex-center">
                                    ...
                                    <div class="border border-gray-300 border-dashed rounded py-3 px-3 mx-4 mb-3">
                                        ...
                                        <div class="fw-semibold text-muted">Résolu</div>
                                    </div>
                                    <!--end::Stats-->
                                    <!--begin::Stats-->
                                    <div class="border border-gray-300 border-dashed rounded py-3 px-3 mb-3">
                                        ...
                                        <div class="fw-semibold text-muted">En Cours</div>
                                    </div>
                                    <!--end::Stats-->
                                </div> --}}
                                <!--end::Info-->
                            ...
                            <div class="d-flex flex-stack fs-4 py-3">
                                <div class="fw-bold rotate collapsible" data-bs-toggle="collapse"
                                    ...
                                    aria-controls="kt_user_view_details">Détail
                            ...
                            <div id="kt_user_view_details" class="collapse show">
                                <div class="pb-5 fs-6">
                                    ...
                                    <div class="text-gray-600">
                                        <a href="#"
                                            class="text-gray-600 text-hover-primary">{{ $userInfo['email'] }}</a>
                                    </div>
                                    <!--begin::Details item-->
                                    <!--begin::Details item-->
                                    <div class="fw-bold mt-5">Phone</div>
                                    <div class="text-gray-600"><span>{{ $userInfo['phone'] }}</span>,
                                    </div>
                                    <!--begin::Details item-->
                                    <!--begin::Details item-->
                                    <div class="fw-bold mt-5">Langue d'Affichage</div>
                                    <div class="text-gray-600">{{ LaravelLocalization::getCurrentLocaleNative() }}
                                    </div>
                                    <!--begin::Details item-->
                                    <!--begin::Details item-->
                                    <div class="fw-bold mt-5">Date De Création</div>
                                    <div class="text-gray-600">{{ $userInfo['created_at'] }}</div>
                                    <!--begin::Details item-->
                                </div>
                            </div>
                            <!--end::Details content-->
                ...
                <div class="flex-lg-row-fluid ms-lg-15">
                    <!--begin:::Tabs-->
                    <ul
                        class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8 bg-dark p-2 rounded-2">
                        <!--begin:::Tab item-->
                        <li class="nav-item">
                            <a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab"
                                href="#kt_user_view_overview_tab">Aperçu général</a>
                        </li>
                        <!--end:::Tab item-->
                        <!--begin:::Tab item-->
                        <li class="nav-item">
                            <a class="nav-link text-active-primary pb-4" data-kt-countup-tabs="true"
                                data-bs-toggle="tab" href="#kt_user_view_overview_security">Sécurité</a>
                        </li>
                        <!--end:::Tab item-->
                        <!--begin:::Tab item-->
                        {{-- <li class="nav-item">
                        ...
                        {{-- <li class="nav-item ms-auto">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold py-4 w-250px fs-6"
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-5">
                                    <a href="javascript:;" class="menu-link px-5">Receive Newsletter</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-5 my-1">
                                    <a href="javascript:;" class="menu-link text-danger px-5">Deactivate Account</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-5">
                                    <a href="javascript:;" class="menu-link text-danger px-5">Delete account</a>
                                </div>
                                <!--end::Menu item-->
                            </div>
                            <!--end::Menu-->
                    ...
                    <div class="tab-content" id="myTabContent">
                            ...
                            <div class="card card-flush mb-6 mb-xl-9">
                                ...
                                <div class="card-header mt-6">
                                    ...
                                    <div class="card-title flex-column">
                                        <h2 class="mb-1">Requête vers le support</h2>
                                        <div class="fs-6 fw-semibold text-muted">Emettre une requête vers le support lorsque vous contactez un bug</div>
                                    </div>
                                    <!--end::Card title-->
                                    <!--begin::Card toolbar-->
                                    <div class="card-toolbar">
                                        <button type="button" class="btn btn-light-primary btn-sm"
                                            ...
                                            <!--end::Svg Icon-->Emettre une requête
                                        </button>
                                    </div>
                                    <!--end::Card toolbar-->
                                </div>
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center position-relative mb-7">
                                        ...
                                        <div class="fw-semibold ms-5">
                                            <a href="#"
                                                class="fs-5 fw-bold text-dark text-hover-primary">Schedule a
                                    ...
                                    <!--end::Item-->
                                    {{-- <img src="{{asset('assets/images/coming.png')}}" alt=""> --}}
                                    <div class="d-flex justify-content-center fs-1 p-20"><span style="font-size: 30px;color: red;">COMING SOON</span></div>
                                ...
                                <div class="card-header border-0">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <button type="button" class="btn btn-sm btn-flex btn-light-primary"
                                            ...
                                            <!--end::Svg Icon-->Fermer Toutes Les Sessions
                                        </button>
                                        <!--end::Filter-->
                                    </div>
                                    <!--end::Card toolbar-->
                                        ...
                                        <table class="table align-middle table-row-dashed gy-5"
                                            ...
                                            <thead class="border-bottom border-gray-200 fs-7 fw-bold">
                                                ...
                                                <tr class="text-start text-muted text-uppercase gs-0">
                                                    ...
                                                    {{-- <th>Device</th> --}}
                                                    <th>Addresse IP</th>
                                                    <th class="min-w-125px">Navigateur</th>
                                                    <th class="min-w-70px">Heure</th>
                                                </tr>
                                                <!--end::Table row-->
                                            </thead>
                                            <!--end::Table head-->
                                            ...
                                            <tbody class="fs-6 fw-semibold text-gray-600">
                                                ...
                                                @foreach ($userSessionLog as $item)
                                                    <tr>
                                                        {{-- <td>{{$item->user_id}}</td> --}}
                                                        <!--end::Status=-->
                                                        <!--begin::Amount=-->
                                                        ...
                                                        <td>{{ \Carbon\Carbon::parse($item->last_activity)->format('j F, Y') }}</td>
                                                    </tr>
                        ...
                        <div class="tab-pane fade" id="kt_user_view_overview_security" role="tabpanel">
                            <!--begin::Card-->
                            <div class="card pt-4 mb-6 mb-xl-9">
                                <form class="edit-user" method="post" action="{{ route('profile.update') }}">
                                    @csrf
                                    @method('patch')
                                    <!--begin::Card header-->
                                    <div class="card-header border-0">
                                    ...
                                    <div class="card-body pt-0 pb-5">
                                                ...
                                                <tbody class="fs-6 fw-semibold text-gray-600">
                                                    <tr>
                                                        ...
                                                        <td><input
                                                                ...
                                                                type="text" value="{{ $userInfo['fname'] }}"
                                                                name="fname"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Nom</td>
                                                        <td><input
                                                                class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                                type="text" value="{{ $userInfo['lname'] }}"
                                                                name="lname"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Phone</td>
                                                        <td>
                                                            <div class="row">
                                                                <input
                                                                    class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                                    type="tel" id="phone"
                                                                    value="{{ $userInfo['phone'] }}" name="phone">
                                                        </td>
                                        </div>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><input
                                                    class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                    type="text" value="Administrator"></td>
                                        </tr>
                                        </tbody>
                                        <!--end::Table body-->
                                        </table>
                        ...
                        <div class="card pt-4 mb-6 mb-xl-9">
                            ...
                            <div class="card-header border-0">
                                <!--begin::Card title-->
                                <div class="card-title flex-column">
                                    <h2 class="mb-1">Authentification en deux étapes</h2>
                                    <div class="fs-6 fw-semibold text-muted">Assurez la sécurité de votre compte avec une deuxième étape d'authentification.</div>
                                </div>
                                <!--end::Card title-->
                                <!--begin::Card toolbar-->
                                {{-- <div class="card-toolbar">
                                    ...
                                    <button type="button" class="btn btn-light-primary btn-sm"
                                        ...
                                        <!--end::Svg Icon-->Ajouter une étape d'authentification
                                    </button>
                                    <!--begin::Menu-->
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-6 w-200px py-4"
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link px-3" data-bs-toggle="modal"
                                                data-bs-target="#kt_modal_add_one_time_password">Activer mot de
                                                passe à usage unique</a>
                                        </div>
                                        <!--end::Menu item-->
                                    </div>
                                    <!--end::Menu-->
                            ...
                            <div class="card-body pb-5">
                                <div class="d-flex justify-content-center">
                                    <span style="font-size: 30px;color: red;"> COMING SOON</span>
                                </div>
                                <!--begin::Item-->
                                {{-- <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex flex-column">
                                        <span>SMS</span>
                                        <span class="text-muted fs-6">{{ $userInfo['phone'] }}</span>
                                    </div>
                                    <!--end::Content-->
                                    <!--begin::Action-->
                                ...
                                <!--end:Separator-->
                                <!--begin::Disclaimer-->
                                <div class="text-gray-600">Si vous perdez votre appareil mobile ou votre clé de
                                    sécurité, vous pouvez pouvez <a href='#' class="me-1">générer un code
                                        de sauvegarde pour </a>se connecter à votre compte.
                                </div>
                                <!--end::Disclaimer--> --}}
                            </div>
                            <!--end::Card body-->
                            ...
                            <div class="card-header border-0">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <button type="button" class="btn btn-sm btn-light-primary">
                                        ...
                                        <!--end::Svg Icon-->Télécharger le rapport
                                    </button>
                                    <!--end::Button-->
                                </div>
                                <!--end::Card toolbar-->
                                    ...
                                    <table
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <!--end::Badge=-->
                                                <!--begin::Status=-->
                                                <td>POST /v1/invoice/in_9907_4486/invalid</td>
                                                <!--end::Status=-->
                                                <!--begin::Timestamp=-->
                                                <td class="pe-0 text-end min-w-200px">15 Apr 2023, 9:23 pm
                                                </td>
                                                <!--end::Timestamp=-->
                                            </tr>
                                            <!--end::Table row-->
                                            ...
                                            <tr>
                                                ...
                                                <!--end::Badge=-->
                                                <!--begin::Status=-->
                                                <td>POST /v1/customer/c_63de6bfcf11f1/not_found</td>
                                                <!--end::Status=-->
                                                <!--begin::Timestamp=-->
                                                <td class="pe-0 text-end min-w-200px">20 Jun 2023, 6:05 pm
                                                </td>
                                                <!--end::Timestamp=-->
                                            </tr>
                                            <!--end::Table row-->
                                            ...
                                            <tr>
                                                ...
                                                <!--end::Badge=-->
                                                <!--begin::Status=-->
                                                <td>POST /v1/invoices/in_6462_1226/payment</td>
                                                <!--end::Status=-->
                                                <!--begin::Timestamp=-->
                                                <td class="pe-0 text-end min-w-200px">15 Apr 2023, 5:30 pm
                                                </td>
                                                <!--end::Timestamp=-->
                                            </tr>
                                            <!--end::Table row-->
                                            ...
                                            <tr>
                                                ...
                                                <!--end::Status=-->
                                                <!--begin::Timestamp=-->
                                                <td class="pe-0 text-end min-w-200px">10 Mar 2023, 6:43 am
                                                </td>
                                                <!--end::Timestamp=-->
                                            </tr>
                                            <!--end::Table row-->
                                            ...
                                            <tr>
                                                ...
                                                <!--end::Status=-->
                                                <!--begin::Timestamp=-->
                                                <td class="pe-0 text-end min-w-200px">21 Feb 2023, 8:43 pm
                                                </td>
                                                <!--end::Timestamp=-->
                                            </tr>
                                            <!--end::Table row-->
                                ...
                                <table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-semibold gy-5"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <!--end::Event=-->
                                            <!--begin::Timestamp=-->
                                            <td class="pe-0 text-gray-600 text-end min-w-200px">20 Dec 2023,
                                                5:20 pm</td>
                                            <!--end::Timestamp=-->
                                        </tr>
                                        <!--end::Table row-->
        ...
        <div class="modal fade" id="kt_modal_update_password" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <!--begin::Modal title-->
                        <h2 class="fw-bold">@php echo ucfirst(__('profile.pwd-update.card-title')); @endphp</h2>
                        <!--end::Modal title-->
                        <!--begin::Close-->
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        <!--begin::Form-->
                        <form id="kt_modal_update_password_form" class="form" method="post" action="{{ route('password.update') }}">
                            @csrf
                            @method('put')
                            <!--begin::Input group=-->
                            <div class="fv-row mb-10">
                                <label class="required form-label fs-6 mb-2">@php echo ucfirst(__('profile.pwd-update.current-password')); @endphp</label>
                            ...
                            <div class="mb-10 fv-row" data-kt-password-meter="true">
                                ...
                                <div class="mb-1">
                                    <!--begin::Label-->
                                    <label class="required form-label fw-semibold fs-6 mb-2">@php echo ucfirst(__('profile.pwd-update.new-password')); @endphp</label>
                                    <!--end::Label-->
                                    <!--begin::Input wrapper-->
                                ...
                                <!--end::Wrapper-->
                                <!--begin::Hint-->
                                <div class="text-muted">@php echo ucfirst(__('profile.pwd-update.valid-pwd')); @endphp</div>
                                <!--end::Hint-->
                            </div>
                            <!--end::Input group=-->
                            <!--begin::Input group=-->
                            <div class="fv-row mb-10">
                                <label class="required form-label fw-semibold fs-6 mb-2">@php echo ucfirst(__('profile.pwd-update.confirm-password')); @endphp</label>
                            ...
                            <div class="text-center pt-15">
                                <button type="reset" class="btn btn-light me-3"
                                    data-kt-users-modal-action="cancel" data-bs-dismiss="modal">@php echo ucfirst(__('button.discard')); @endphp</button>
                                <button type="submit" class="btn btn-primary"
                                    data-kt-users-modal-action="submit">
                                    <span class="indicator-label">@php echo ucfirst(__('button.submit')); @endphp</span>
                                    <span class="indicator-progress">@php echo ucfirst(__('profile.pwd-update.wait')); @endphp
                                        <span
                                            class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                                </button>
                            </div>
