<div>
    ...
    <button type="button" class="btn btn-light-primary me-3 p-3" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
    ...
    <div id="kt_datatable_example_export_menu"
        ...
        <div class="menu-item px-3">
            <a href="javasctipt:;" class="menu-link px-3" data-kt-export="copy">
                Copy to clipboard
            </a>
        </div>
        <!--end::Menu item-->
        <!--begin::Menu item-->
        <div class="menu-item px-3">
            <a href="javasctipt:;" class="menu-link px-3" data-kt-export="excel">
                Export as Excel
            </a>
        </div>
        <!--end::Menu item-->
        <!--begin::Menu item-->
        <div class="menu-item px-3">
            <a href="javasctipt:;" class="menu-link px-3" data-kt-export="csv">
                Export as CSV
            </a>
        </div>
        <!--end::Menu item-->
        <!--begin::Menu item-->
        <div class="menu-item px-3">
            <a href="javasctipt:;" class="menu-link px-3" data-kt-export="pdf">
                Export as PDF
            </a>
        </div>
        <!--end::Menu item-->
