            ...
            <div class="col-sm-6">
                ...
                <div class="d-flex flex-column h-100">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="symbol symbol-30px symbol-circle me-3">
                                    <span class="symbol-label bg-success">
                                        ...
                                        <span class="svg-icon svg-icon-5 svg-icon-white"><svg width="24"
                    ...
                    <div class="d-flex flex-stack mt-auto bd-highlight">
                        ...
                        <!--end::Users group-->
                        <!--begin::Actions-->
                        <a href="?page=apps/projects/project" class="text-primary opacity-75-hover fs-6 fw-semibold">
                            View Project
                            <!--begin::Svg Icon | path: icons/duotune/arrows/arr095.svg-->
                            <span class="svg-icon svg-icon-4 svg-icon-gray-800 ms-1"><svg width="24" height="24"
